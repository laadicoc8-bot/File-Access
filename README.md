...
# Start
clear()
print(Fore.GREEN + Style.BRIGHT + r"""____________________$
___________________$$$
__________________$$$$$
_________________$$$$$$$
________________$$$$$$$$$
...
ID = input(f"{Fore.WHITE + Style.BRIGHT}ENTER YOUR TELEGRAM USER ID : {Fore.RESET}").strip()
...
if not access_granted:
    print(f"{Fore.RED}❌ Access Denied. Contact @beasteren for paid access.")
    sleep(2)
    os._exit(0)
...
LEO=render(' LOVE           PREET  ',colors=stein_colors,align='center',font='block',background='black')
